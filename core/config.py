...
Zia_WAKE_PHRASE = (os.environ.get("Zia_WAKE_PHRASE") or "Welcome back sir, how can I help you?").strip()
INTERRUPT_PHRASES = ["shut up", "stop talking", "quiet", "abort", "cancel", "enough"]
