...
def register_all(router: Router) -> None:
    ...
    from skills import apps, media, system, web, notes, weather, timers, clipboard, window_manager, automation

    # Registration order matters: first match wins.
    # More specific patterns should come before broad ones.
    for module in (web, system, media, apps, notes, weather, timers, clipboard, window_manager, automation):
        try:
